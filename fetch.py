#!/usr/bin/env python3
"""
Recupero codici sconto EMP da shopilo.it
Sursa: https://shopilo.it/negozi/emp-online.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/emp-online.it"
STORE_NAME = "EMP"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per EMP da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-emp)"
    }
    try:
